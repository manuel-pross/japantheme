    ...
    <footer class="footer">
        <div class="footer__upper">
            <div class="footer__container">
                ...
                <div class="footer__container">
                    <div class="footer__mail"> <!-- align items centerr flex -->
                    <svg class="footer__mail-svg" viewBox="0 0 20 20">
                            ...
                            <span class="footer__mail-link">
                                <a href="mailto:pro_manuel@yahoo.de" class="footer__mail-adress">pro_manuel@yahoo.de</a>
                            </span>
                    </svg>
                    </div>
                    ...
                    <svg class="footer__phone-svg" viewBox="0 0 20 20">
                        ...
                        <a href="" class="footer__phone-number">0179563202</a>
                    </div>
                </div>
            </div>
            <div class="footer__container">
