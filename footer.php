...
<?php
    $insta_link = get_field('footer_insta_link');
?>
...
<?php wp_footer(); ?>
    ...
    <footer class="footer">
            ...
            <div class="footer__container">
                ...
                <div class="footer__container">
                    <div class="footer__mail">
                        <a href="mailto:pro_manuel@yahoo.de" class="footer__mail-link">
                            ...
                            <span class="footer__mail-text">pro_manuel@yahoo.de</span>
                        </a>
                    </div>
        ...
        <div class="footer__lower">
                <?php
                    if( $insta_link ):
                        $link_url = $insta_link['url'];
                        $link_title = $insta_link['title'];
                        $link_target = $insta_link['target'] ? $insta_link['target'] : '_self';
                ?>
                <a class="footer__icon" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?>
                <?php endif; ?>
